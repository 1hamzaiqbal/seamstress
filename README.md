...
* Tighten macOS automation by automatically capturing active applications during time capsules (via `osascript`).
* Expand the visualization layer (e.g., Rich dashboard or a lightweight Textual TUI).
* Persist focus session live notes and integrate with Jupyter or VS Code tasks.
* Add iCalendar export for the two-hour sprint plan.
